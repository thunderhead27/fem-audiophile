...
export const Browse = () => {
  return (
    <div tw="flex flex-col tablet:flex-row gap-x-4 laptop:gap-x-8 mt-24">
      ...
      <Link href="/speakers">
        <div tw="flex flex-col">
          ...
          <div tw="flex flex-col h-40 w-80 tablet:w-48 tablet:h-40 laptop:h-52 laptop:w-[350px] relative bg-darkGray top-[-90px] tablet:top-[-86px] laptop:top-[-145px] desktop:top-[-151px] z-[-10] self-center rounded-lg pt-20 laptop:pt-32 text-center font-sans font-bold">
            <span>SPEAKERS</span>
            <div tw="flex flex-row items-center justify-center">
              <span tw="opacity-50 mr-2">SHOP</span>
              <Arrow />
